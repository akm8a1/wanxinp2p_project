package com.liu.wanxinp2p.uaa.config;


import com.liu.wanxinp2p.uaa.domain.IntegrationUserDetailsAuthenticationHandler;
import com.liu.wanxinp2p.uaa.domain.IntegrationUserDetailsAuthenticationProvider;
